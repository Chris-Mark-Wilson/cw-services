export const HomeAutomation = () => {
    return (
        ...
        <section className='details'>
        <details name='details' className='description'>{/*open*/}
            <summary id='summary' >What is Home Automation?</summary>
        ...
        <details name='details' className='description'>
            <summary id='summary' >How does it work?</summary>
        ...
        <details name='details' className='description'>
            <summary id='summary' >
                ...
                <details name='details'>
                    <summary id='summary' >What is Zigbee and why use it?</summary>
                ...
                <details name='details'>
                    <summary id='summary'>How do I 'talk' to the system?</summary>
                ...
                <details name='details'>
                        <summary id='summary'>Are there any privacy concerns?</summary>
